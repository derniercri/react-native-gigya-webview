...
static NSString *const MessageHandlerName = @"gsapi";
...
- (void)setMessagingEnabled:(BOOL)messagingEnabled {
  ...
  static NSString *const MessageHandlerNameSettings = @"__gigAPIAdapterSettings";
  ...
  [
    ...
    initWithSource: [
      ...
      "  }"
      "};", MessageHandlerNameSettings, MessageHandlerName
    ]
    injectionTime:WKUserScriptInjectionTimeAtDocumentStart
